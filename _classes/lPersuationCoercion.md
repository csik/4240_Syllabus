...
---
As previously messaged, lecture today is asynchronous! You can find it in Canvas, in two parts, under today's date in the Modules tab. I've linked it below as well. I cover some of the arguments for and against design techniques like Persuasive computation, and offer more focused ways for discussing the dualism between a) design that controls and b) a user's freedom.
