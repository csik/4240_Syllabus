...
4. Develop **2-3 variations of each** design/lifeworld pairing. For example, you might change the context of the design, change the technological platform it is instantiated in, or change the potential audience of the design. You will have time to workshop your designs during section on Nov. 10 and Nov. 17.
...
6. You'll now make a final design. This should build from what you've learned so far, but must be its own stand-alone design. It might be a much further developed idea based on one of the three sketches, but if so it needs to be genuinely developed and not simply more detailed. It shouldn't just be a stew of the three sketches -- it should stand on its own, using a specific critical design strategy.
...
8. The project is due on **Dec. 3** at ¡4:00pm! <- note the early time!>.
