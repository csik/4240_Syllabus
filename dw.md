...
Designers tend to go through a lot of drafts before making a final design. The **design workbooks** are weekly speculative designs done in response to course readings. Because this class focuses on understanding design at a high level, we're actually looking for your design argumentation with the readings more than the design itself. Think of it as the equivalent to a "reading response" in a humanities course, where you show that you've done the reading, and have thought about and reflected on it.

**Design workbooks** are commonly used in the early (research and ideation) stage of a design. They are a method for exploring the parameters of the design's context, addressing specific issues or premises that underpin the design, or playing with materials or techniques that might be included in the design. Particularly in the early stages of design, design workbooks are explicitly **not** intended to provide a straightforward answer to a design problem, but instead explore trade-offs and possible directions that the final design might foreclose upon or ellide. That is to say, a design workbook at this stage **does not contain practical solutions that a designer would expect to be implemented, but rather "speculative" designs that help them to understand the nature of the problem** they are facing. The design is often annotated with brief explanations for communicating to others, or to the designer later when they might be in a different headspace. These annotated designs may also tentatively explore the possible social worlds, new experiences, or implications opened up by the design.

### Our workbooks
#### What we mean when we say Design Workbook
In this course, when we say "design workbooks," most of the time we're referring to the short (one page, or two pages at most) PDF submissions you'll be making to Canvas every week. They can take many forms, and we encourage you to experiment a bit with format and style at the beginning of the semester, when we're grading pass-fail. We'll show examples of prior students' workbooks, but we generally love adventurous submissions.

While we mostly mean "your weekly assignment" when we say "design workbooks," we may also be referring to 1) a physical workbook that you keep as a way to take notes on the readings and generate your assignments, or 2) the larger method of workbooks, as used by Bill Gaver and other designers we discuss in class.

So even though submissions are PDF, most designers keep one or many notebooks that they can always scribble notes into[.](https://stuffwhitepeoplelike.com/2009/02/24/122-moleskine-notebooks/) We *strongly suggest* that you do the same. It's important to make notes, drawings, and scribbles *while* you are reading. It's far more easy to be inspired while reading, or right after, than days or weeks later. If you are inspired directly while reading, or right after reading, your work might be good enough to be submitted right away. In other cases, though, you may want to refine, edit, or redraw/rewrite a bit before submitting. We don't require that you keep this physical workbook, but we secretely hope that you're keeping an actual notebook, and using it to make your immediate notes and to iterate on designs.
